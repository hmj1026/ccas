...
5. **Other installed skills** (python-patterns, backend-patterns, api-design, etc. — resolve from the runtime catalog) — minimum necessary set
...
- **Project rules win on conflicts**: apply the repository rules and the selected runtime skill; do not assume an absent project-local skill directory exists
