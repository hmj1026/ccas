...
- **同名 skill 以專案內版本為準**：若本地 `.agents/skills/` 有同名版本，優先於全域 ECC skill
- **software-architecture 為通用指引**：該 ECC skill 含 JS/npm 相關建議（arrow functions、Redux 等），與 CCAS Python 後端無關；遇到衝突時以專案 rules（`python.md`、`python-api.md`）為準
