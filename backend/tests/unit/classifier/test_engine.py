...
class TestClassify:
    def _make_rule(
        ...
        return ClassificationRule(rule_id=rule_id, keyword=keyword, category=category)

    def test_single_match(self) -> None:
        rules = RuleSet(rules=(self._make_rule(1, "星巴克", "餐飲"),))
