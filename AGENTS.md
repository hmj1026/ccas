...
This project is indexed by GitNexus as **ccas** (14005 symbols, 24458 relationships, 262 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
